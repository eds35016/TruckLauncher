...
// Truck pack version tracking
bool BaseInstance::isTruckPack() const
{
    bool result = m_settings->get("TruckPack").toBool();
    qDebug() << "BaseInstance::isTruckPack() for" << name() << "returning:" << result;
    qDebug() << "  TruckPack setting value:" << m_settings->get("TruckPack");
    return result;
}

QString BaseInstance::getTruckPackName() const
{
    QString result = m_settings->get("TruckPackName").toString();
    qDebug() << "BaseInstance::getTruckPackName() for" << name() << "returning:" << result;
    return result;
}

QString BaseInstance::getTruckPackVersion() const
{
    QString result = m_settings->get("TruckPackVersion").toString();
    qDebug() << "BaseInstance::getTruckPackVersion() for" << name() << "returning:" << result;
    return result;
}
