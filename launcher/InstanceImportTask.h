...
class InstanceImportTask : public InstanceTask {
   ...
   public:
    ...
    // Truck pack info accessors
    bool hasPendingTruckPackInfo() const { return m_hasPendingTruckPackInfo; }
   ...
   private: /* data */
    ...
    // Store truck pack info to apply after instance creation
    bool m_hasPendingTruckPackInfo = false;
